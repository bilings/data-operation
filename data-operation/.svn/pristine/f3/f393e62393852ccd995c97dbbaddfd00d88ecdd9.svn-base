var estateIndex_obj = {
        ...
        $('#estateIndex_wrapper #searchBtn').on('click', function () {
            _this.tableIns.reload({
                where: {
                    ...
                    name: $('#estateIndex_wrapper #name').val(),
    ...
    _displayTable: function () {
        ...
        _this.tableIns = layui.table.render({
            ...
            cols: [[
                ...
                {field: 'totalNumberOfBuildings', title: '预计总栋数'},
    ...
    _initBar: function () {
        ...
        layui.table.on('tool(estateTable)', function (obj) {
            ...
            if (obj.event === 'hide') {
                // 隐藏和可见相互切换
                var visibility = data.visibility === '0' ? '2' : '0';
    ...
    _gotoBuilding: function (id, name) {
        parent.homeIndex_obj._addTab('楼栋-' + name, '../building/index.html?communityId=' + id, false, '');
    },
