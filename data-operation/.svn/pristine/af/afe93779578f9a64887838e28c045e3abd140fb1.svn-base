...
public class BuiltController extends BasicController {
    ...
    @PostMapping("/merge")
    @RequiredPermission("100")
    public ApiResult merge(@RequestBody List<Map<String,String>> bl) {
        return builtService.merges(bl);
    }
     ...
     * @return String 返回结果
     */
    @RequestMapping("/waitMergeList")
    @RequiredPermission("401")
    public String waitMergeList(Pagination pages, BusWaitMergeEtyDto bwd) {
        // 分页数据
