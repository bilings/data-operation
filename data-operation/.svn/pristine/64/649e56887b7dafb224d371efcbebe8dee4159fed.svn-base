...
public class SettingController {
    ...
    @GetMapping("dictList")
    public ApiResult<List<BusDictionary>> dictList() {
        List<BusDictionary> list = dictionaryService.query();
    ...
    public ApiResult<List<BusDictionary>> dictionary(Long id, String category) {
        List<BusDictionary> list = dictionaryService.query(id, category);
        return ApiResult.success(list);
    }
    ...
    public ApiResult<List<BusDictionaryVO>> dictionaryTitle(Long id, String category) {
        List<BusDictionaryVO> list = new ArrayList<>();
//                dictionaryService.queryTitle(id, category);
        return ApiResult.success(list);
    }
